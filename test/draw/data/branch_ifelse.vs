      ...
      80: 6f 00 40 01  	j	0x94 <vs_main+0x94>
      84: 03 25 04 fc  	lw	a0, -64(s0)
      88: 1b 05 85 0c  	addiw	a0, a0, 200
      8c: 23 20 a4 fc  	sw	a0, -64(s0)
      ...
      b0: 83 30 81 03  	ld	ra, 56(sp)
      b4: 03 34 01 03  	ld	s0, 48(sp)
      b8: 13 01 01 04  	addi	sp, sp, 64
      bc: 67 80 00 00  	ret
