     ...
     11c: 43 f0 20 00  	fmadd.s	ft0, ft1, ft2, ft0
     120: 27 22 04 f8  	fsw	ft0, -124(s0)
     124: 03 35 04 f6  	ld	a0, -160(s0)
     128: 07 20 45 00  	flw	ft0, 4(a0)
     12c: 87 20 04 f8  	flw	ft1, -128(s0)
     130: 07 21 c5 00  	flw	ft2, 12(a0)
     134: 43 f0 20 00  	fmadd.s	ft0, ft1, ft2, ft0
     138: 27 20 04 f8  	fsw	ft0, -128(s0)
     13c: 07 20 44 f8  	flw	ft0, -124(s0)
     140: 03 35 04 fd  	ld	a0, -48(s0)
     144: 83 35 04 fe  	ld	a1, -32(s0)
     148: 13 06 c0 01  	li	a2, 28
     14c: b3 85 c5 02  	mul	a1, a1, a2
     150: 33 05 b5 00  	add	a0, a0, a1
     154: 27 20 05 00  	fsw	ft0, 0(a0)
     158: 07 20 04 f8  	flw	ft0, -128(s0)
     15c: 03 35 04 fd  	ld	a0, -48(s0)
     160: 83 35 04 fe  	ld	a1, -32(s0)
     164: b3 85 c5 02  	mul	a1, a1, a2
     168: 33 85 a5 00  	add	a0, a1, a0
     16c: 27 22 05 00  	fsw	ft0, 4(a0)
     170: 07 20 c4 f7  	flw	ft0, -132(s0)
     174: 03 35 04 fd  	ld	a0, -48(s0)
     178: 83 35 04 fe  	ld	a1, -32(s0)
     17c: b3 85 c5 02  	mul	a1, a1, a2
     180: 33 85 a5 00  	add	a0, a1, a0
     184: 27 24 05 00  	fsw	ft0, 8(a0)
     188: 07 20 84 f7  	flw	ft0, -136(s0)
     18c: 03 35 04 fd  	ld	a0, -48(s0)
     190: 83 35 04 fe  	ld	a1, -32(s0)
     194: b3 85 c5 02  	mul	a1, a1, a2
     198: 33 85 a5 00  	add	a0, a1, a0
     19c: 27 26 05 00  	fsw	ft0, 12(a0)
     1a0: 07 20 44 f7  	flw	ft0, -140(s0)
     1a4: 03 35 84 fc  	ld	a0, -56(s0)
     1a8: 83 35 04 fe  	ld	a1, -32(s0)
     1ac: b3 85 c5 02  	mul	a1, a1, a2
     1b0: 33 85 a5 00  	add	a0, a1, a0
     1b4: 27 28 05 00  	fsw	ft0, 16(a0)
     1b8: 07 20 04 f7  	flw	ft0, -144(s0)
     1bc: 03 35 84 fc  	ld	a0, -56(s0)
     1c0: 83 35 04 fe  	ld	a1, -32(s0)
     1c4: b3 85 c5 02  	mul	a1, a1, a2
     1c8: 33 85 a5 00  	add	a0, a1, a0
     1cc: 27 2a 05 00  	fsw	ft0, 20(a0)
     1d0: 07 20 c4 f6  	flw	ft0, -148(s0)
     1d4: 03 35 84 fc  	ld	a0, -56(s0)
     1d8: 83 35 04 fe  	ld	a1, -32(s0)
     1dc: b3 85 c5 02  	mul	a1, a1, a2
     1e0: 33 85 a5 00  	add	a0, a1, a0
     1e4: 27 2c 05 00  	fsw	ft0, 24(a0)
     1e8: 13 05 00 00  	li	a0, 0
     1ec: 83 30 81 09  	ld	ra, 152(sp)
     1f0: 03 34 01 09  	ld	s0, 144(sp)
     1f4: 13 01 01 0a  	addi	sp, sp, 160
     1f8: 67 80 00 00  	ret
