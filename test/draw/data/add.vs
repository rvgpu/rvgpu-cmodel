      ...
      54: 1b 05 45 06  	addiw	a0, a0, 100
      58: 23 20 a4 fc  	sw	a0, -64(s0)
      5c: 03 25 04 fc  	lw	a0, -64(s0)
      60: 83 35 04 fd  	ld	a1, -48(s0)
      64: 03 36 04 fe  	ld	a2, -32(s0)
      68: 13 16 26 00  	slli	a2, a2, 2
      6c: b3 85 c5 00  	add	a1, a1, a2
      70: 23 a0 a5 00  	sw	a0, 0(a1)
      74: 13 05 00 00  	li	a0, 0
      78: 83 30 81 03  	ld	ra, 56(sp)
      7c: 03 34 01 03  	ld	s0, 48(sp)
      80: 13 01 01 04  	addi	sp, sp, 64
      84: 67 80 00 00  	ret
